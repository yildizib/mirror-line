...
void main() {
  ...
  test('onProgress fires once per batch with correct indices and total', () async {
    ...
    try {
      ...
      expect(found, '127.0.0.1', reason: 'scan should find the localhost server');
      expect(progress, isNotEmpty);
      expect(progress.first.$1, 1, reason: 'first callback is batch 1');
      expect(progress.first.$2, 11, reason: '254 hosts / 24 concurrency = 11 batches');
